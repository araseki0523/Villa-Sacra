        ...
        <div class="introduction__each-wrapper introduction__each-wrapper-tora">
            <div class="introduction__container">
                ...
                <div class="introduction__image-wrapper introduction__image-wrapper-tora">
                    ...
                    <div class="introduction__capacity">部屋定員：1～2 名</div>
                    <div class="introduction__breadth">部屋の広さ：6 平米</div>
                </div>
            </div>
            <div class="introduction__text-area">
        ...
        <div class="introduction__each-wrapper introduction__each-wrapper-nizi">
            <div class="introduction__container introduction__container-even">
                ...
                <div class="introduction__image-wrapper">
                    ...
                    <p class="introduction__person">ragazzi works</p>
                    <div class="introduction__capacity">部屋定員：1～4 名</div>
...
<section class="blog-top layout-blog-top">
    <div class="blog-top__inner">
        <div class="blog-top__title-area section-title">
            <h2 class="blog-top__title-ja section-title__ja">新着情報</h2>
...
<section class="access layout-access">
    <div class="access__inner">
        <div class="access__title-area section-title">
            <h2 class="access__title-ja section-title__ja">アクセス</h2>
            <p class="access__title-en section-title__en">Access</p>
        </div>
        <div class="access__map-area" id="wrapper">
